  ...
  return (
    <form action={action} className="v2-form">
      ...
      <div className="v2-actions">
        ...
        <Button type="submit" name="decision" value="dismissed" variant="destructive" size="sm" className="v2-btn-danger" disabled={pending || !note.trim()}>
          기각
        </Button>
        {pending && <span className="v2-note">저장 중…</span>}
        {!note.trim() && <span className="v2-note">기각하려면 사유를 적는다</span>}
      </div>
